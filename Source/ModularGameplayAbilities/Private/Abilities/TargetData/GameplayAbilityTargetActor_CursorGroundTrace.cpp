...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GameplayAbilityTargetActor_CursorGroundTrace)

AGameplayAbilityTargetActor_CursorGroundTrace::AGameplayAbilityTargetActor_CursorGroundTrace(
...
void AGameplayAbilityTargetActor_CursorGroundTrace::StartTargeting(UGameplayAbility* Ability)
{
...
FHitResult AGameplayAbilityTargetActor_CursorGroundTrace::PerformTrace(AActor* InSourceActor)
{
...
bool AGameplayAbilityTargetActor_CursorGroundTrace::IsConfirmTargetingAllowed()
{
	return bLastTraceWasGood;
}

bool AGameplayAbilityTargetActor_CursorGroundTrace::AdjustCollisionResultForShape(
